...
<title>My Portofolio | Emah</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark shadow-sm fixed-top" style="background-color: #3dcaf5;">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <a class="nav-link active" href="{{asset('pdf')}}/Sertifikat-IT.pdf">Certificate</a>
            <a class="nav-link active" href="{{asset('pdf')}}/IPS_1905005_SEMESTER_1-5.pdf">GPA</a>
            @if (Route::has('login'))
                <div class="">
                    @auth
    ...
    <section class="jumbroton text-center text-info" style="padding-top: 6rem; background-color: #87e3ff;">
        ...
        <p class="fw-bold  lead">Software Developer | Laravel</p>
    ...
    <section id="about" style="padding-top: 5rem;">
        ...
        <div class="row justify-content-center">
            ...
            <p>
                ...
                I am a back-end developer who is experienced in making applications, especially with the Laravel framework. I have also deployed my application with Microsoft Azure cloud computing. I am a fast learner and flexible in completing the given task.</p>
            </div>
            </div>
            <div class="col-md-4 mb-4">
            <h4 class="text-center">Personal Information</h4>
            <div class="biodata">
                <p>Name : Emah Khujaemah<br>
                <!-- Status : college student<br> -->
                Collage : Indramayu State Polytechnic<br>
    ...
    <!-- Project -->
    <section id="project" style="background-color: #bfe8f5; padding-top: 5rem;">
        <div class="container">
        ...
        <div class="row justify-content-center m-lg-5">
            ...
            <div class="card mt-3">
                ...
                <p class="card-text">A website made using the laravel framework, this website was created when following a coding challenge.</p>
                <a name="start-bootstrap" id="start-bootstrap" class="btn btn-primary p-3" href="http://penata-rias-mua.azurewebsites.net" role="button">Start Penata Rias</a>  
                </div>
            </div>
            </div>
            <div class="col-md-4">
            <div class="card mt-3">
                <img src="{{asset('img')}}/syousetsu-blog.jpeg" class="card-img-top" alt="Project 2" width="100px">
                <div class="card-body">
                <h5 class="card-title">Syousetsu Website</h5>
                <p class="card-text">Websites made using the Laravel framework are useful for adding posts, especially about the novel category.</p>
                <a name="start-bootstrap" id="start-bootstrap" class="btn btn-primary p-3" href="https://khuzaemah-novel.azurewebsites.net" role="button">Start Blog-Novel</a>  
                </div>
            </div>
            </div>
            <div class="col-md-4">
            <div class="card mt-3">
                <img src="{{asset('img')}}/start-bootstrap.jpg" class="card-img-top" alt="Project 2" width="100px">
                <div class="card-body">
                <h5 class="card-title">Landing Page</h5>
                <p class="card-text">One of the landing pages made by myself using HTML, CSS, and Bootstrap. I saw the design from the internet and made it from scratch. This landing page is responsive.</p>
                <a name="start-bootstrap" id="start-bootstrap" class="btn btn-primary p-3" href="https://khuzaemah.github.io/star-bootstrap" role="button">Start Bootstrap</a>  
                </div>
            </div>
            </div>
            <div class="col-md-4">
            <div class="card mt-3">
                <img src="{{asset('img')}}/rock-paper-scissors.jpeg" class="card-img-top" alt="Project 2" width="100px">
                <div class="card-body">
                <h5 class="card-title">Rock Paper Scissors Game</h5>
                <p class="card-text">A simple website made to be able to play Rock Paper Scissors game with Computer using javascript</p>
                <a name="start-bootstrap" id="start-bootstrap" class="btn btn-primary p-3" href="https://khuzaemah.github.io/rock-paper-scissors/" role="button">Start Game</a>  
                </div>
            </div>
            </div><div class="col-md-4">
            <div class="card mt-3">
                <img src="{{asset('img')}}/bookshelf-apps.jpeg" class="card-img-top" alt="Project 2" width="100px">
                <div class="card-body">
                <h5 class="card-title">Bookshelf Apps</h5>
                <p class="card-text">A simple website created to store a history of books that have been read using javascript</p>
                <a name="start-bootstrap" id="start-bootstrap" class="btn btn-primary p-3" href="https://khuzaemah.github.io/bookshelf-emah/" role="button">Start Bookshelf</a>  
                </div>
            </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="card mt-3">
                ...
                <p class="card-text">Applications built using Android Studio. This application is used to record items on the counter.</p>
                </div>
            </div>
            </div>
            ...
            <div class="card mt-3">
                ...
                <p class="card-text">Websites created using the PHP language-based Laravel framework. Contains data on students, lecturers and other employees regarding the Indramayu State Polytechnic Campus. There is also a page that is used to store personal relative data. </p>
                </div>
            </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="row justify-content-center">
                ...
                <form action="send.php" method="post" target="_blank"> 
                    ...
                    <input type="text" class="form-control" id="nama" name="name"  aria-describedby="nama" placeholder="Write Your Full Name">
                    </div>
                    <div class="mb-3">
                    <label for="email" class="form-label">Email address</label>
                    <input type="email" class="form-control" id="email" aria-describedby="email" name="email" placeholder="Example : example@example.com">
                    </div>
                    <div class="mb-3">
    ...
    <section id="topbar" class="d-flex align-items-center">
        <div class="container d-md-flex d-sm-block justify-content-center justify-content-md-between ">
            ...
            <a href="https://www.fiverr.com/emah24" class="fiverr"><img src="{{asset('img')}}/fiverr.png" width="15px"></a>
            </div>
        </div>
    </section>
    ...
    <script src="{{asset('img')}}//jquery-3.6.0.min.js"></script>
    <script src="{{asset('img')}}//bootstrap.js"></script>
    <script src="{{asset('img')}}//popper.min.js"></script>
    </body>
